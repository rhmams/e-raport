              ...
              <div className="card">
                ...
                <div className="announcement-list">
                  <div className="announcement-item">
                    <div className="announcement-date">25 Mei 2026</div>
                    <div className="announcement-title">Libur Hari Raya Idul Adha</div>
                    <div className="announcement-desc">Diumumkan kepada seluruh siswa bahwa libur Hari Raya Idul Adha jatuh pada tanggal 10-12 Juni 2026.</div>
                  </div>
                  <div className="announcement-item">
                    <div className="announcement-date">20 Mei 2026</div>
                    <div className="announcement-title">Pendaftaran Ekstrakurikuler Baru</div>
                    <div className="announcement-desc">Pendaftaran ekstrakurikuler untuk semester ganjil dibuka mulai 1-10 Juni 2026.</div>
                  </div>
                </div>
              </div>
            </div>
