...
const aspekSpiritual = [
  { id: "sholat", label: "Ketaatan Sholat", desc: "Kedisiplinan menjalankan sholat 5 waktu" },
  { id: "quran", label: "Tilawah Al-Qur'an", desc: "Kebiasaan membaca dan menghafal Al-Qur'an" },
  { id: "akhlak", label: "Akhlak & Adab", desc: "Sopan santun dan perilaku islami" },
  { id: "ibadah", label: "Ibadah Sunnah", desc: "Pelaksanaan ibadah sunnah (puasa, dzikir, dll)" },
];
...
function NilaiSpiritual() {
  ...
  const totalTerisi = dataSiswaContoh.filter(s =>
    aspekSpiritual.every(a => nilaiData[`${s.id}-${a.id}`])
  ).length;
  ...
  return (
    <div className="page">
        ...
        <div className="navbar-inner">
          <div className="nav-left">
            ...
            <div className="nav-text">
              ...
              <div className="breadcrumb">Guru <ChevronRight size={12} /> Nilai <ChevronRight size={12} /> Spiritual</div>
            </div>
          </div>
      ...
      <div className="layout">
        ...
        <main className="main spiritual-main">
          <div className="container">
            <div className="spiritual-header">
              <div className="spiritual-header-left">
                <button className="btn-back" onClick={() => navigate(-1)}><ChevronLeft size={16} /> Kembali</button>
                <div className="spiritual-title-wrap">
                  <div className="spiritual-icon-wrap"><Star size={26} /></div>
                  <div>
                    <h1>Nilai Spiritual</h1>
                    <p className="subtitle">Penilaian sikap spiritual siswa — Kelas {activeKelas.kelas} · {activeKelas.mapel}</p>
                  </div>
                </div>
              </div>
              <div className="spiritual-header-right">
              ...
              <table className="nilai-table">
                ...
                <tbody>
                  {filteredSiswa.map((siswa, idx) => {
                    const semua = aspekSpiritual.every(a => nilaiData[`${siswa.id}-${a.id}`]);
                    return (
            ...
            <div className="action-footer">
              ...
              <button className={`btn-save-lg ${saved ? 'saved' : ''}`} onClick={handleSave}>
                {saved ? <><CheckCircle size={18} /> Nilai Berhasil Disimpan</> : <><Save size={18} /> Simpan Semua Nilai Spiritual</>}
              </button>
            </div>
          </div>
        </main>
